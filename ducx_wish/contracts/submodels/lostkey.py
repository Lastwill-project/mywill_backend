...
class ContractDetailsLostKeyTokens(CommonDetails):
    ...
    ducx_contract = models.ForeignKey(
        DUCXContract,
        null=True,
        default=None,
    ...
    def compile(self, ducx_contract_attr_name='ducx_contract_token'):
        ...
        dest, preproc_config = create_directory(
            self, sour_path='ducx_wish/eth-lost-key-token/*',
        ...
        ducx_contract.abi = token_json['abi']
        ducx_contract.bytecode = token_json['bytecode'][2:]
        ducx_contract.compiler_version = token_json['compiler']['version']
        ducx_contract.contract = self.contract
        ducx_contract.original_contract = self.contract
        ducx_contract.source_code = source_code
        ducx_contract.save()
        self.ducx_contract = ducx_contract
        self.save()
